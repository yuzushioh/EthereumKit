...
final class ERC20Tests: XCTestCase {
    func testGenerateTransactionData() {
        ...
        let data1 = ERC20.generateData(with: address, amount: "3", decimal: 18)
        XCTAssertEqual(
        ...
        let data2 = ERC20.generateData(with: address, amount: "0.25", decimal: 18)
        XCTAssertEqual(
        ...
        let data3 = ERC20.generateData(with: address, amount: "0.155555", decimal: 18)
        XCTAssertEqual(
